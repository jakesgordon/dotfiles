...
" JAKE HACK - because I have custom [] based tokens in my markdown, it fucks up the link matching below, so 
"           temporarily comment those out and put in my own more rudimentary matching for the time being.
syn match ciToken /\[.*\]/
syn match ciToken /\[.*\](.*)/
